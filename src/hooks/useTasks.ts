...
interface UseTasksState {
  ...
  undoDelete: () => void;
  setLastDeleted: (task: Task | null) => void;
}
...
export function useTasks(): UseTasksState {
  ...
  return { tasks, loading, error, derivedSorted, metrics, lastDeleted, addTask, updateTask, deleteTask, undoDelete, setLastDeleted };
}
